...
if(isset($_POST[Titre])){
        $req = $bdd->prepare('UPDATE artiste SET Titre = :nvTitre, Texte = :nvTexte, Photo = :nvPhoto  WHERE Id_Artiste   = 1 ');
        $req->execute(array(
        'nvTitre' => $_POST[Titre],
        'nvTexte' => $_POST[Texte],
        'nvPhoto' => $image
...
<html lang="fr">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">MODIFICATION PAGE ARTISTE</h1>
      ...
      <!--Formulaire --> 
          <form method="POST" action="modif_artiste.php" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea  class="" id="Texte" name="Texte" ><?php echo $donnees['Texte'] ?></textarea>
                <script type="text/javascript">
